...
class User < ActiveRecord::Base
  ...
  attr_accessible :login, :first_name, :last_name, :email, :password, :password_confirmation, :activation_code, :activated_at
  ...
  def self.authenticate(login, password)
    ...
    u = find(:first, :conditions => ["login = ? AND activated_at IS NULL", login.downcase]) # need to get the salt
